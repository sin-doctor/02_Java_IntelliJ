...
public class 어노테이션 {
    /*
    @ (어노테이션, Annotation = 주석 주석을 다는 행위 설명 부가정보)
    註釋 = 주석
            註 덧붙이다 설명하다 주
            釋 풀다 해석하다 석
    Spring 주로 사용
    ...
    오버라이딩
        ...
        두번쨰 이후 다른 클래스가 자식 클래스에 맞게 다시 구현하는 것을

        부모 클래스에서 메서드에 주과된 이름, 매개변수 ,리턴타입은 그대로
        하지만 메서드의 동작은 변경할 수 있음

        예를 들어 toString 메서드가 대표적인 예
        최초로_toSting_이 만들어진 클래스.java
    ...
    */
     ...
     *
     * }
     * @AllArgsConstructor = 모든 매개변수값을 저장하는 필수 생성자
     *
