...
public class ArrayEx3 {
    // Heap 에 저장되어있는 기능
    public void method1() {
        /*이차원 배열은 배열 안에 배열이 있는 형태로, 배열의 배열 행(row)과 열(Column) 구성된 데이터 구조
        표나 행령의 형태로 데이터를 저장할 때 사용
        ...
        배열의 차원 :
                ...
                배열 선언 및 초기화 : 타입 [][]배열명 = new 타입 [행의 개수][열의 개수];
                배열 선언 및 초기화 : 타입 배열명[][]  = new 타입 [행의 개수][열의 개수];
                배열 선언 및 초기화 : [][] 타입 배열명  = new 타입 [행의 개수][열의 개수]; XXXXXXX
    ...
    public void method3() {
        String[][] fruits = {
                // index 0 번째 자리에 그룹
                {"사과","빨강","단맛","중간"}, //과일1 사과의 정보 index 0번
                {"귤","오렌지","새콤","작음"}, //과일2 귤의 정보 index 1번
                {"포도","보라","달콤","작음"} //과일3 포도의 정보 index 2번
        };
        System.out.println("과일 1:"+fruits[0][0] + "(색상:"+fruits[0][1]+ ",맛"+fruits[0][2]+",크기:"+fruits[0][3]+")");
        System.out.println("과일 1:"+fruits[1][0] + "(색상:"+fruits[1][1]+ ",맛"+fruits[1][2]+",크기:"+fruits[1][3]+")");
        System.out.println("과일 1:"+fruits[2][0] + "(색상:"+fruits[2][1]+ ",맛"+fruits[2][2]+",크기:"+fruits[2][3]+")");

        //주의해야할 점 없는자리에 있는 값을 가져오려하면 문제가 발생
        //index는 무조건 0부터 순차적으로 자동 번호 매김이 됨
        //마음대로 바꾸기 X
        //만약에 길이가 3인 배열에 index 0,1번째 값 기입 안했다면
        //index[0] = 0
        //index[1] = 0
        //index[2] = 개발자가 기입한 숫자;
