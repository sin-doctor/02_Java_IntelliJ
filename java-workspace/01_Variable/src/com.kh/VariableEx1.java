...
public class VariableEx1 {
    ...
    public static void main(String[] args) {
        ...
        // 프로젝트 하나 하는데 왜 이렇게 변수가 많은지.. 와 같은 변수
         ...
         *
         * long	   변수명 = long
         * long    롱2번 = 1000000000L; //long 사용 long 리터럴은 L 필수로 뒤에 와야함
         *
         * [실수형]
         ...
         * 플롯 1번의 공간의 크기를 float으로 주고 실수 뒤에 f를 붙여주지 않으면
         * 실수는 기본리터럴 형인 double로 인식이 되어
         * 공간보다 큰 메모리가 온다고 컴퓨터는 인식을 하고 오류를 발생하기 때문에
         * 앞에 예약어를 float으로 작성했다면 소수 뒤에는 f를 붙여주는것
         *
         * L이나 f같은 리터럴 표기법은
        ...
        char 문자3번 ='A';
        //char 문자3번 = "A"; char 문제에는 반드시 '' 감싸기!

        float 소수1번 = 3.14f;//Type mismatch:cannot convert from double to
